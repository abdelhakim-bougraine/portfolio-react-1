...
const Home = () => {
  return (
    // Zdna "pt-24" aw "pt-32" bach t-hbet l-photo mn ta7t l-navbar
    <div className="relative min-h-screen flex items-center justify-center bg-[#050a15] overflow-hidden pt-24 md:pt-32">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <h1 className="text-5xl md:text-8xl font-serif font-bold text-white mb-8 tracking-tight leading-tight">
          Abdelhakim <span className="text-transparent bg-clip-text bg-gradient-to-b from-yellow-200 via-yellow-500 to-yellow-800">Bougraine</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <Link to="/projects" className="w-full sm:w-auto px-12 py-4 bg-[#d4af37] text-[#050a15] font-black rounded-2xl shadow-[0_10px_40px_rgba(212,175,55,0.3)] hover:shadow-yellow-500/60 transition-all hover:-translate-y-1 uppercase tracking-[0.15em] text-xs text-center">
             Mes Réalisations
          </Link>
          <Link to="/about" className="w-full sm:w-auto px-12 py-4 border-2 border-yellow-600/40 text-[#d4af37] font-bold rounded-2xl hover:bg-yellow-600/10 transition-all backdrop-blur-lg text-xs uppercase tracking-widest text-center">
            Mon Profil
          </Link>
        </div>

        {/* Social Icons */}
        <div className="mt-20 pb-10 flex justify-center space-x-12">
          <a href="https://github.com/abdelhakim-bougraine" target="_blank" rel="noreferrer" className="text-slate-500 hover:text-[#d4af37] text-2xl transition-all transform hover:scale-125">
            <i className="fab fa-github"></i>
          </a>
          <a href="https://linkedin.com/in/abdelhakim-bougraine" target="_blank" rel="noreferrer" className="text-slate-500 hover:text-[#d4af37] text-2xl transition-all transform hover:scale-125">
